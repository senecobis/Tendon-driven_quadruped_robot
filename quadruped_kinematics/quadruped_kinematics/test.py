...
# ik.ikine(0, -0.065, 0, legs12=True)
# ik.invkine_leg(0, -0.65, 0)

# stick_figure = SpotMicroStickFigure(x=0, y=0, z=0, phi=0, theta=-15, psi=0)
# stick_figure
...
ax.plot(list(range(0,10)), list(range(0,10)),list(range(0,10)))
...
plt.savefig('spot_micro_leg.png')
plt.show()
